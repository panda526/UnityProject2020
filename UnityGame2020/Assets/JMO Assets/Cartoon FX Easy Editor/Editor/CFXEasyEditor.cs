...
public class CFXEasyEditor : EditorWindow
{
	...
	private float LTargetSyscalingValue = 1.0f;
	...
	//----------------------------------------------------------------
		...
		//----------------------------------------------------------------
			...
			LTargetSyscalingValue = EditorGUILayout.FloatField(LTargetSyscalingValue,GUILayout.Width(50));
			if(LTargetSyscalingValue < 0.0f) LTargetSyscalingValue = 0.0f;
			else if(LTargetSyscalingValue > 9999) LTargetSyscalingValue = 9999;
			GUILayout.EndHorizontal();
...
#if UNITY_5_5_OR_NEWER
				var main = ps.main;
				main.simulationSpeed = LTargetSyscalingValue;
#else
				ps.playbackSpeed = LTargetSyscalingValue;
#endif
			}
		}
	}
